...
def optimize_control_points(P0, P1, P2, P3):
    ...
    def objective(params):
        ...
        P1 = P0 + k * P1_dir
        P2 = np.array([P2x, P2y])
        length = curve_length(P0, P1, P2, P3)
        max_k, _ = find_max_curvature(P0, P1, P2, P3)
        return length + 100000*max_k

    initial_params = [1.0, P2[0], P2[1]]
    result = minimize(objective, initial_params, bounds=[(1, None), (None, None), (None, None)])
    k_opt, P2x_opt, P2y_opt = result.x
    P1_opt = P0 + k_opt * P1_dir
